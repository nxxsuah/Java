...
public class StringTest {
	...
	public static void main(String[] args) {
		...
		System.out.println("str2 : " + str2.toString()); // toString 생략
		...
		if(str1 == str2) {
			...
			// String은 객체라서 heap 메모리에서 주소값이 stack 에서 사용됨 
			// 그래서 다르다고 나타나기 때문에 Equals 를 사용해서 비교해야함
			}
		
		if(str1.equals(str2)) {
			System.out.println("str1, str2 문자열이 같다");
		} else {
			System.out.println("str1, str2 문자열이 다르다"); // String은 객체라서 heap 메모리에서 주소값이 stack 에서 사용됨
		}
		
		// 문자열 길이
		String message = "Hello, World"; // 12문자
		...
		String sub2 = message.substring(7);
		System.out.println("sub1 : " + sub1);
		System.out.println("sub2 : " + sub2);
		
			
		// 문자열 인덱스
		int index1 = message.indexOf("l");		//문자열 앞에서 부터 소문자 l 검색 후 인덱스 변환
		int index2 = message.lastIndexOf("l");	//문자열 뒤에서 부터 소문자 l 검색 후 인덱스 변환
